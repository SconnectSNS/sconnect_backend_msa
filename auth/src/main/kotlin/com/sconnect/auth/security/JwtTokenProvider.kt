package com.sconnect.auth.security

import com.sconnect.auth.model.dto.JwtTokenDto
...
open class JwtTokenProvider(
    ...
    fun checkSessionExpired(sessionCode: String): Boolean {
        return getClaimsFromToken(sessionCode)!!.expiration.after(Date())
    }
